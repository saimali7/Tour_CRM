...
const createTourSchema = z.object({
  ...
  pickupMode: z.enum(["meeting_point", "hotel_pickup", "hybrid"]).optional(),
  pickupAllowedCities: z.array(z.string().max(120)).max(20).optional(),
  pickupAirportAllowed: z.boolean().optional(),
